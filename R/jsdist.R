...
#' jsdist(p=prob1, q=prob1, type='prob', unit='log2')
#' # P|Q
#' jsdist(p=prob1, q=prob2, type='prob', unit='log2')
#' # Q|P
#' jsdist(p=prob2, q=prob1, type='prob', unit='log2')
#'
jsdist<- function(p, q, type=NULL, unit='log2'){
